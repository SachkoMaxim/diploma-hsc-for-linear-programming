...
class ConsoleVisualizer {
    public:
        ...
        static inline void printMatrix(const std::string& name,
        ...
        static inline void printMatrixTransposed(const std::string& name,
                                                 const std::vector<double>& mat,
                                                 int rows, int cols) {
            std::cout << name << ":\n";
        ...
        static inline void printSimplexStatus(const std::string& name,
                                              SimplexStatus s) {
            std::cout << name << ": ";
            switch (s) {
