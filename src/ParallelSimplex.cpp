...
#pragma omp parallel num_threads(P) private(T_id)
    {
...
#pragma omp single
        {
            ...
            for (int i = 0; i < data.m; ++i) {
                ...
                if (data.constraintTypes[i] == ConstraintType::GREATEREQ)
...
void ParallelSimplex::computeReducedCosts(std::vector<double> &c_j) {
    // n = c_TB * B_m1
